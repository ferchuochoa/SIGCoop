...
__all__ = ['Account', 'Sector', 'AccountTemplate', 'SectorTemplate', 'CreateChartAccount', 'CreateChart']
...
class AccountTemplate(ModelSQL, ModelView):
    ...
    sector_id = fields.Many2One('account.sector.template', 'Sector', ondelete="RESTRICT", required=False)
...
class Account(ModelSQL, ModelView):
    ...
    sector_id = fields.Many2One('account.sector', 'Sector', ondelete="RESTRICT", required=False)
...
class CreateChart(Wizard):
    ...
    def transition_create_account(self):
        ...
        with Transaction().set_context(language=Config.get_language(),
            ...
            template2sector = {}
            account_template.sector_id.create_sector(self.account.company.id, template2sector=template2sector)
